...
public class Simples {
	public String Simples_Run() throws Exception {
		...
		//linhas.run_Caracteres();
		//Import_Y import_Y = new Import_Y();
		//System.out.println(import_Y.run_Import_Y());
		
		linhas.run_Caracteres();
		Import_T import_T = new Import_T();
		System.out.println(import_T.run_Import_T());
...
class Import_2{
	public String run_Import_2() throws IOException {
		System.err.println("3. Servidor UDP e Cliente\n"
				+ "Servidor UDP\n");
...
class Import_3{
	public String run_Import_3() throws IOException{
		System.err.println("Cliente de Arquivos\n");
...
class Import_Y{
	public String run_Import_Y() throws IOException {
		System.err.println("2. Envio de Arquivo via Socket\r\n"
...
class Import_T{
	public String run_Import_T() throws IOException {
		System.err.println("\n");
